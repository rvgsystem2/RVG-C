            ...
            <div class="container text-center py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb justify-content-center mb-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('contact') }}">service</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="bg-light border border-danger shadow-sm h-100">
                                ...
                                <div class="px-0">
                                    ...
                                    <div class="border-bottom  border-danger px-2 py-2">Custom Images & LED Videos for Shop
                                        TV</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Video Reels Package for Social
                                        Media</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Birthday / Anniversary Post Package
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">Daily Gold/Silver Rate Posters
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">Custom Post for Print / Web /
                                        Packaging / Ads</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Voice‑over Video Creation
                                        <small>(with voice)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">Jewellery Catalog Design
                                        <small>(PDF / Print)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">Festival & Campaign Branding Pack
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">3D Jewellery Mockups / Renders
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="bg-light border border-danger shadow-sm h-100">
                                ...
                                <div class="px-0">
                                    ...
                                    <div class="border-bottom  border-danger px-2 py-2">Gold Silver Live Rate App / Website
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">E‑commerce Website <small>(Buy/Sell
                                            Jewellery Online)</small></div>
                                    ...
                                    <div class="border-bottom  border-danger px-2 py-2">Employee Attendance & Salary
                                        Management</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Inventory Software <small>(Stock
                                            Tracking)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">Online Booking / Virtual Try‑On
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">Custom CRM for Jewellery
                                        <small>(Customer tracking)</small></div>
                        ...
                        <div class="col-12">
                            <div class="bg-light border border-danger shadow-sm h-100">
                                ...
                                <div class="px-0">
                                    <div class="border-bottom  border-danger px-2 py-2">Social Media Handling
                                        <small>(Monthly Package)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">Google Business Verification
                                        <small>(Improve local search)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">Facebook & Instagram Ads</div>
                                    <div class="border-bottom  border-danger px-2 py-2">SEO Optimisation <small>(Improve
                                            search ranking)</small></div>
                                    ...
                                    <div class="border-bottom  border-danger px-2 py-2">Official WhatsApp Verified Service
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">Google Review & Rating Management
                                    </div>
                                    <div class="border-bottom  border-danger px-2 py-2">Content Writing for Website</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Influencer Marketing <small>(Local
                                            + Bridal)</small></div>
                                    <div class="border-bottom  border-danger px-2 py-2">YouTube Setup + Reels Editing</div>
                                    <div class="border-bottom  border-danger px-2 py-2">Pinterest Marketing for Bridal
                                        Jewellery</div>
